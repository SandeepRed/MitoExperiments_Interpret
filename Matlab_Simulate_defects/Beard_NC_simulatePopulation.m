function [OCR, delPsi_basal, ATP_m_basal, NADH_m_basal, ATP_c_basal,H2O2_basal,...
...
NADH_m_FC_drug1, NADH_m_FC_drug2] = Beard_NC_simulatePopulation(expt, Par_vary, percent_cells)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%3%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if setRNG == 1
    rng(1)
    fprintf('\nInitialised random number generator seed [rng(2)]')
end
...
[xparAll, stateVarAll,stateVarFCAll,stateVarAll1,...
    ...
    v_otherpar4,v_otherpar6,...
     ...
     options, xo_single_cell, plot_ss, statevar_legend, printSim, percent_cells);
...
median_response = median_OutputAll(:, 4);
OCR = median_response(4:stepsize*600:end);
delPsi_basal = median_stateVarAll1(19);
ATP_m_basal = median_stateVarAll1(8);
NADH_m_basal = median_stateVarAll1(4);
ATP_c_basal = median_OutputAll1(24);
H2O2_basal = median_stateVarAll1(25);

delPsi_drug1 = median_stateVarAll30(19);
ATP_m_drug1 = median_stateVarAll30(8);
NADH_m_drug1 = median_stateVarAll30(4);
ATP_c_drug1 = median_OutputAll30(24);
delPsi_drug2 = median_stateVarAll45(19);
ATP_m_drug2 = median_stateVarAll45(8);
NADH_m_drug2 = median_stateVarAll45(4);
ATP_c_drug2 = median_OutputAll45(24);

delPsi_FC_drug1 = nanmedian(median_stateVarFCAll(295:305,19))
delPsi_FC_drug2 = nanmedian(median_stateVarFCAll(445:455,19))

ATP_m_FC_drug1 = nanmedian(median_stateVarFCAll(295:305,8))
ATP_m_FC_drug2 = nanmedian(median_stateVarFCAll(445:455,8))

NADH_m_FC_drug1 = nanmedian(median_stateVarFCAll(295:305,4))
NADH_m_FC_drug2 = nanmedian(median_stateVarFCAll(445:455,4))
...
% response = OutputAll(:, 4);
% OCR = response(4:stepsize*600:end);
% delPsi_basal = stateVarAll1(19);
% ATP_m_basal = stateVarAll1(8);
% NADH_m_basal = stateVarAll1(4);
% ATP_c_basal = OutputAll1(24);
% H2O2_basal = stateVarAll1(25);
% 
% delPsi_drug1 = stateVarAll30(19);
% ATP_m_drug1 = stateVarAll30(8);
% NADH_m_drug1 = stateVarAll30(4);
% ATP_c_drug1 = OutputAll30(24);
% 
% delPsi_drug2 = stateVarAll45(19);
% ATP_m_drug2 = stateVarAll45(8);
% NADH_m_drug2 = stateVarAll45(4);
% ATP_c_drug2 = OutputAll45(24);





%%%For All Simulations data%%
% 
% OCR_1 = squeeze(OutputAll(:,4,:));
% 
% for i = 1:size(OCR_1,2)
%     response = OCR_1(:, i);
%     OCR(:,i) = response(4:stepsize*600:end)
% end
% 
% 
% delPsi_basal = stateVarAll1(:, 19);
...
% ATP_c_drug2 = OutputAll45(:, 24);
% 
% %FC for delPsi all sims
% delPsi_FC = squeeze(stateVarFCAll(:,19,:));
% delPsi_FC_drug1 = nanmedian(delPsi_FC(295:305,:))
% delPsi_FC_drug2 = nanmedian(delPsi_FC(445:455,:))
% 
% ATP_m_FC = squeeze(stateVarFCAll(:,8,:))
% ATP_m_FC_drug1 = nanmedian(ATP_m_FC(295:305,:))
% ATP_m_FC_drug2 = nanmedian(ATP_m_FC(445:455,:))
% 
% NADH_m_FC = squeeze(stateVarFCAll(:,4,:))
% NADH_m_FC_drug1 = nanmedian(NADH_m_FC(295:305,:))
% NADH_m_FC_drug2 = nanmedian(NADH_m_FC(445:455,:))
